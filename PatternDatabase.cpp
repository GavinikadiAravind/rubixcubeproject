...
bool PatternDatabase::setNumMoves(const Generalrubikscube &cube, const uint8_t numMoves) {
...
uint8_t PatternDatabase::getNumMoves(const Generalrubikscube &cube) const {
